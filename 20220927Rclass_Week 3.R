...
rairuoho_day <- rairuoho %>% pivot_longer(cols = 1:6, 
                                          names_to = 'day', 
                                          values_to = 'length') #cols = day3:day8
...
#rairuoho %>% unite('spatial coordinates', spatial1:spatial2, sep = '_')
